    ...
    StadiumCard: (stadium) => {
        ...
        <div class="stadium-card" style="position:relative;">
            ...
            <div class="stadium-info">
                ...
                <button class="btn btn-primary" style="width:100%; padding:16px; font-size:16px;" onclick="location.href='${window.root}user/book.php?id=${stadium.id}'" data-i18n="btn_book_now">حجز الآن</button>
            </div>
        </div>
        `;
    }
